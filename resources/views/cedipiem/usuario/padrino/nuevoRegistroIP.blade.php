						...
						<div class="card-header text-md-center" style="color: gray;"><i class="fa fa-user"></i> {{ 'MANTENIMIENTO AL DIRECTORIO DE PADRINOS' }}<div class="text-md-center" style="color:blue; ">{{'PROGRAMA GUBERNAMENTAL: '}}  {!! $programa->programa !!}</div></div>
							...
							<div class="card-body">
								...
								<div class="justify-content-center">
									<div class="mol-md-8">
										<div class="card">
											<div class="card-header justify-content-center  text-md-center">{{ 'CARTA DE AUTORIZACIÓN DE DESCUENTOS VÍA NÓMINA' }}<div>{{ 'PERSONAS DE SERVICIO PÚBLICO' }}</div>
											<div style="color:red;">{{'SECTOR: '}}{!! $clasificgob->clasificgob_desc !!}</div>
										</div>
										</div>
									</div>
								</div>
									...
									<div class="col-md-10 offset-md-1 text-justify">
										<div class = "form-group row">
											...
											<div class="col-md-5 offset-md-0">
												{!! Form::text('SUSCRIBE',null,['class' => 'form-control','placeholder' => 'Apellido paterno, materno y nombre(s)']) !!}
											</div>
